...
/*
 *
 * libpsec Changes (by Pedro A. Hortas on 02/09/2014):
...
void RIPEMD160_init(uint32_t *MDbuf);
/*
 *  initializes MDbuffer to "magic constants"
 */

void RIPEMD160_compress(uint32_t *MDbuf, uint32_t *X);
/*
 *  the compression function.
 *  transforms MDbuf using message bytes X[0] through X[15]
 */

void RIPEMD160_finish(uint32_t *MDbuf, const uint8_t *strptr, uint32_t lswlen, uint32_t mswlen);
/*
