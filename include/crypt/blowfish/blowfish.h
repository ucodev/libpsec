 ...
 * Notes:
 *
 * - Si and Pi arrays were imported from Bruce Schneier implementation.
 *
 */

#ifndef LIBPSEC_BLOWFISH_LOW_H
#define LIBPSEC_BLOWFISH_LOW_H
...
/* Statics */
static const uint32_t Pi[NROUNDS + 2] = {
...
static const uint32_t Si[4][256] = {
...
/* Types */
typedef struct blowfish_struct {
	unsigned int rounds;
	uint32_t P[NROUNDS + 2];
	uint32_t S[4][256];
} blowfish_context;
