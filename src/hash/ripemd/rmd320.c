...
/* NOTE: The following disclaimer is for the rmd160.c file, which was the base of work for this
 *       file (rmd320.c).
 *
 */
...
void RIPEMD320_compress(uint32_t *MDbuf, uint32_t *X)
{
   ...
   uint32_t aaa = MDbuf[5], bbb = MDbuf[6], ccc = MDbuf[7],
         ddd = MDbuf[8], eee = MDbuf[9];
