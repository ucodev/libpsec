...
void RIPEMD128_init(uint32_t *MDbuf)
{
...
void RIPEMD128_compress(uint32_t *MDbuf, uint32_t *X)
{
...
void RIPEMD128_finish(uint32_t *MDbuf, const uint8_t *strptr, uint32_t lswlen, uint32_t mswlen)
{
