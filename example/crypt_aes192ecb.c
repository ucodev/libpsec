...
int main(void) {
	...
	encrypted = crypt_encrypt_aes192ecb(NULL, &encrypted_out_len, plain, sizeof(plain), NULL, key);

	decrypted = crypt_decrypt_aes192ecb(NULL, &decrypted_out_len, encrypted, encrypted_out_len, NULL, key);
