...
int main(void) {
	...
	crypt_encrypt_chacha8(encrypted, &encrypted_out_len, plain, sizeof(plain), nonce, key);

	crypt_decrypt_chacha8(decrypted, &decrypted_out_len, encrypted, encrypted_out_len, nonce, key);
